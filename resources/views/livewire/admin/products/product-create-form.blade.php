...
new class extends Component {
    ...
    /**
     * Get all subcategories with id as value, and name as label.
     */
    #[Computed]
    ...
    /**
     * Set subcategoryId value when the combobox component change.
     */
    ...
    /**
     * Remove product variation variant.
     */
     ...
     * @return  void
     *
     * @throws  AuthorizationException if the user is not authorized to create new product.
    ...
    public function save()
    {
        ...
        try {
            ...
            Log::error('Database query error occurred', [
                ...
                'user_id' => auth()->id(),
                'context' => [
                    'operation' => 'Creating product data',
            ...
            session()->flash(
                'error',
                'Terjadi kesalahan dalam menambahkan produk baru, silakan coba beberapa saat lagi.',
            );
            return $this->redirectIntended(route('admin.products.index'), navigate: true);
        } catch (\Exception $e) {
...
>
        ...
        <div class="p-4">
            ...
            >
                ...
                <div class="flex items-center gap-5">
                    @if ($form->thumbnail)
                        <div
                            class="size-28 shrink-0 overflow-hidden rounded-md border-2 border-dashed border-neutral-300"
                        >
                            <img
                    ...
                    @else
                        ...
                        >
                            <svg
                                x-show="!isUploading"
                                class="size-8 shrink-0 text-black/70"
                ...
                >
                    <div class="mb-2 flex items-center gap-x-3">
                        ...
                        <div>
                            <p x-text="thumbnail?.name" class="text-sm font-medium tracking-tight text-black"></p>
                            <p
                                x-text="formatFileSize(thumbnail?.size)"
            ...
            <div class="mt-4">
                ...
                <x-form.combobox :options="$this->subcategories" name="subkategori" id="select-subcategory" />
    ...
    <fieldset>
        ...
        <div class="p-4">
            <div class="mb-1 flex w-full cursor-default items-center justify-between">
                <span class="text-sm font-medium tracking-tight text-black">Gambar Produk</span>
            ...
            >
                <div
                    ...
                    x-bind:class="{
                        'bg-red-50 border-red-500':
                            {{ $errors->has('form.images') || $errors->has('form.images.*') ? 'true' : 'false' }},
                        'bg-primary-50 border-primary':
                            ! {{ $errors->has('form.images') || $errors->has('form.images.*') ? 'true' : 'false' }} &&
                            isDropping,
                        'bg-white border-neutral-300':
                ...
                >
                    <div x-show="!isUploading" class="flex h-full flex-col items-center justify-center" x-cloak>
                        <svg
                            class="mb-4 size-12 shrink-0 text-black/70"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <svg
                                                class="size-10 shrink-0 animate-spin fill-primary text-neutral-200"
                                                viewBox="0 0 100 101"
                                                fill="none"
                                                xmlns="http://www.w3.org/2000/svg"
                                                aria-hidden="true"
            ...
            <x-form.input-error :messages="$errors->get('form.images')" class="mt-2" />
            <x-form.input-error :messages="$errors->get('form.images.*')" class="mt-2" />
        </div>
    </fieldset>
    <fieldset>
                ...
                @if (count($form->variation['variants']) < 9)
                    ...
                    >
                        ...
                        >
                            ...
                            <svg
                                class="size-5 shrink-0 animate-spin text-black/70"
                                fill="currentColor"
                                viewBox="0 0 256 256"
                                aria-hidden="true"
                                wire:loading
