...
new class extends Component {
    ...
    public function delete(string $id)
    {
        ...
        try {
            ...
            Log::error('Unexpected user deletion error: ' . $e->getMessage());
        ...
        <div class="relative">
            ...
            <div class="relative">
                <x-form.input
                    ...
                    type="text"
                    role="combobox"
                    placeholder="Cari data pelanggan berdasarkan nama..."
                    autocomplete="off"
                />
                <div
                    wire:loading
        ...
        <table class="w-full text-left text-sm">
            <thead class="border-b border-neutral-300">
                <tr>
                    ...
                    <th scope="col" align="left">
                        <div class="flex items-center gap-x-2 p-4 text-sm font-semibold tracking-tight text-black">
                            Nomor Handphone
                        </div>
                    </th>
                        ...
                        >
                            ...
                            <svg class="w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                ...
                                <polyline
                                    @class([
                                        'text-black/70',
                                        'text-primary' => $sortField === 'orders_count' && $sortDirection === 'desc',
                                    ])
                                    points="80 176 128 224 176 176"
                                    fill="none"
                                    stroke="currentColor"
                                ...
                                <polyline
                                    @class([
                                        'text-black/70',
                                        'text-primary' => $sortField === 'orders_count' && $sortDirection === 'asc',
                                    ])
                                    points="80 80 128 32 176 80"
                                    fill="none"
                                    stroke="currentColor"
            ...
            <tbody class="divide-y divide-neutral-300">
                @forelse ($this->users as $user)
                    ...
                    >
                        ...
                        <td class="min-w-32 p-4 font-normal tracking-tight text-black/70" align="center">
                            {{ $user->orders_count }}
                        </td>
                                        ...
                                        <template x-teleport="body">
                                            ...
                                            >
                                                <div class="flex flex-col items-center p-6">
                                                    ...
                                                    >
                                                        Apakah anda yakin ingin menghapus pelanggan dengan nama
                                                        <strong>"{{ strtolower($user->name) }}"</strong>
                                                        ini ? Proses ini tidak dapat dibatalkan, seluruh data yang
                                                        terkait dengan pelanggan ini akan dihapus dari sistem.
                                                    </p>
                            ...
                            <figure class="my-4 flex h-full flex-col items-center justify-center">
                                ...
                                <figcaption class="flex flex-col items-center">
                                    ...
                                    <p class="text-center text-base font-normal tracking-tight text-black/70">
                                        @if ($search)
                                            Pelanggan yang Anda cari tidak ditemukan, silakan coba untuk mengubah kata kunci
                                        pencarian Anda.
                                        @else
                                            Seluruh pelanggan Anda akan ditampilkan di halaman ini. Anda dapat
                                            menambahkan pelanggan baru dengan menekan tombol
