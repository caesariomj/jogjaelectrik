...
new class extends Component {
     ...
     * @return  void
     *
     * @throws  AuthorizationException if the user is not authorized to create new category.
    ...
    public function save()
    {
        ...
        try {
            ...
            session()->flash('success', 'Kategori ' . $validated['name'] . ' berhasil ditambahkan.');
            ...
            session()->flash(
                'error',
                'Terjadi kesalahan dalam menambahkan kategori baru, silakan coba beberapa saat lagi.',
            );
            return $this->redirectIntended(route('admin.categories.index'), navigate: true);
        } catch (\Exception $e) {
