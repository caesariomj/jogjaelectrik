...
new class extends Component {
     ...
     * @return  void
     *
     * @throws  AuthorizationException if the user is not authorized to delete the category.
    ...
    public function delete(string $id)
    {
        ...
        try {
            ...
            Log::error('Database query error occurred', [
                ...
                'user_id' => auth()->id(),
                'context' => [
                    'operation' => 'Deleting category data',
            ...
            session()->flash(
                'error',
                'Terjadi kesalahan dalam menghapus kategori ' . $categoryName . ', silakan coba beberapa saat lagi.',
            );
            return $this->redirectIntended(route('admin.categories.index'), navigate: true);
        } catch (\Exception $e) {
...
<div>
    <x-datatable.table searchable="kategori">
        <x-slot name="head">
            <x-datatable.row>
                ...
                <x-datatable.heading
                    sortable
                    class="min-w-40"
                    :direction="$sortField === 'is_primary' ? $sortDirection : null "
                ...
                <x-datatable.heading
                    sortable
                    class="min-w-36"
                    :direction="$sortField === 'total_products' ? $sortDirection : null "
                    wire:click="sortBy('total_products')"
                    align="center"
                >
            ...
            @forelse ($this->categories as $category)
                ...
                >
                    ...
                    <x-datatable.cell align="center">
                        ...
                        @else
                            <span
                                class="inline-flex items-center gap-x-1.5 rounded-full bg-neutral-100 px-3 py-1 text-xs font-medium tracking-tight text-black"
                            >
                                <span class="inline-block size-1.5 rounded-full bg-black"></span>
                                Tidak
                            </span>
                        @endif
                    </x-datatable.cell>
                                        ...
                                        >
                                            <div class="flex flex-col items-center p-6">
                                                ...
                                                >
                                                    ...
                                                    dengan kategori ini akan dihapus dari sistem.
                                                </p>
                                                <div
                        ...
                        <figure class="my-4 flex h-full flex-col items-center justify-center">
                            ...
                            <figcaption class="flex flex-col items-center">
                                ...
                                <p class="text-center text-base font-normal tracking-tight text-black/70">
                                    @if ($search)
                                        Data kategori dengan nama
                                        <strong>"{{ $search }}"</strong>
                                        tidak ditemukan, silakan coba untuk mengubah kata kunci pencarian Anda.
                                    @else
                                        Seluruh kategori Anda akan ditampilkan di halaman ini. Anda dapat menambahkan
                                        kategori baru dengan menekan tombol
        ...
        <x-slot name="pagination">
            {{ $this->categories->links('components.common.pagination') }}
        </x-slot>
    </x-datatable.table>
</div>
