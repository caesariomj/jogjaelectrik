...
new class extends Component {
    ...
    public function delete(string $id)
    {
        ...
        try {
            ...
            Log::error('Database error during admin deletion: ', $e->getMessage());
            ...
            Log::error('Unexpected admin deletion error: ' . $e->getMessage());
        ...
        <div class="relative">
            ...
            <div class="relative">
                <x-form.input
                    ...
                    type="text"
                    role="combobox"
                    placeholder="Cari data admin berdasarkan nama..."
                    autocomplete="off"
                />
                <div
                    wire:loading
        ...
        <table class="w-full text-left text-sm">
            <thead class="border-b border-neutral-300">
                <tr>
                        ...
                        >
                            ...
                            <svg class="w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                ...
                                <polyline
                                    @class([
                                        'text-black/70',
                                        'text-primary' => $sortField === 'email' && $sortDirection === 'desc',
                                    ])
                                    points="80 176 128 224 176 176"
                                    fill="none"
                                    stroke="currentColor"
                                ...
                                <polyline
                                    @class([
                                        'text-black/70',
                                        'text-primary' => $sortField === 'email' && $sortDirection === 'asc',
                                    ])
                                    points="80 80 128 32 176 80"
                                    fill="none"
                                    stroke="currentColor"
                        ...
                        >
                            ...
                            <svg class="w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                ...
                                <polyline
                                    @class([
                                        'text-black/70',
                                        'text-primary' => $sortField === 'role' && $sortDirection === 'desc',
                                    ])
                                    points="80 176 128 224 176 176"
                                    fill="none"
                                    stroke="currentColor"
                                ...
                                <polyline
                                    @class([
                                        'text-black/70',
                                        'text-primary' => $sortField === 'role' && $sortDirection === 'asc',
                                    ])
                                    points="80 80 128 32 176 80"
                                    fill="none"
                                    stroke="currentColor"
                    ...
                    @if (auth()->user()->can('edit all accounts') &&auth()->user()->can('delete all accounts'))
            ...
            <tbody class="divide-y divide-neutral-300">
                @forelse ($this->admins as $admin)
                    ...
                    >
                        ...
                        <td class="min-w-40 p-4 font-normal tracking-tight text-black/70" align="left">
                            {{ $admin->email }}
                        </td>
                        <td class="min-w-40 p-4" align="center">
                            <span
                                @class([
                                    ...
                                    'bg-red-100 text-red-800' => $admin->roles->first()->name === 'super_admin',
                                    'bg-blue-100 text-blue-800' => $admin->roles->first()->name === 'admin',
                                ])
                            >
                                <span class="mb-0.5">•</span>
                                {{ $admin->roles->first()->name === 'admin' ? 'Admin' : 'Super Admin' }}
                            </span>
                        </td>
                                                ...
                                                >
                                                    <div class="flex flex-col items-center p-6">
                                                        ...
                                                        >
                                                            ...
                                                            ini ? Proses ini tidak dapat dibatalkan, admin yang telah
                                                            dihapus tidak akan dapat mengakses sistem.
                                                        </p>
                            ...
                            <figure class="my-4 flex h-full flex-col items-center justify-center">
                                ...
                                <figcaption class="flex flex-col items-center">
                                    ...
                                    <p class="text-center text-base font-normal tracking-tight text-black/70">
                                        @if ($search)
                                            Admin yang Anda cari tidak ditemukan, silakan coba untuk mengubah kata kunci
                                        pencarian Anda.
                                        @else
                                            Seluruh admin Anda akan ditampilkan di halaman ini.
                                            @if (auth()->user()->can('create accounts'))
                                                Anda dapat menambahkan admin baru dengan menekan tombol
