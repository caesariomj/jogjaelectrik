...
new class extends Component {
     ...
     * @return  void
     *
     * @throws  AuthorizationException if the user is not authorized to delete the subcategory.
     * @throws  QueryException if a database query error occurred.
     * @throws  \Exception if an unexpected error occurred.
     */
    public function delete(string $id)
    {
        $subcategory = (new Subcategory())->newFromBuilder(Subcategory::queryById(id: $id)->first());
        ...
        try {
            ...
            Log::error('Database query error occurred', [
                ...
                'user_id' => auth()->id(),
                'context' => [
                    'operation' => 'Deleting subcategory data',
...
<div>
    <x-datatable.table searchable="subkategori">
        <x-slot name="head">
            <x-datatable.row>
                                        ...
                                        >
                                            <div class="flex flex-col items-center p-6">
                                                ...
                                                >
                                                    ...
                                                    dengan subkategori ini akan dihapus dari sistem.
                                                </p>
                                                <div
                        ...
                        <div class="my-4 flex h-full flex-col items-center justify-center">
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-center text-base font-normal tracking-tight text-black/70">
                                    @if ($search)
                                        Data subkategori dengan nama
                                        <strong>"{{ $search }}"</strong>
                                        tidak ditemukan, silakan coba untuk mengubah kata kunci pencarian Anda.
                                    @else
                                        Seluruh subkategori Anda akan ditampilkan di halaman ini. Anda dapat menambahkan
                                        subkategori baru dengan menekan tombol
        ...
        <x-slot name="pagination">
            {{ $this->subcategories->links('components.common.pagination') }}
        </x-slot>
    </x-datatable.table>
</div>
