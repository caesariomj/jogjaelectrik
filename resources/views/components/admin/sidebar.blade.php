    ...
    <div id="sidebar-nav" class="h-[calc(100%-4.2rem)] overflow-y-hidden hover:overflow-y-auto">
        <nav class="px-4 py-2">
            <ul class="space-y-1.5">
                ...
                <li class="border-t py-2">
                    <span class="text-xs font-semibold uppercase tracking-tight text-black/50">
                        Penawaran & Penjualan
                    </span>
                </li>
                <li>
                ...
                <li class="border-t py-2">
                    <span class="text-xs font-semibold uppercase tracking-tight text-black/50">Pengaturan</span>
                </li>
                <li>
                    <x-admin.side-link
